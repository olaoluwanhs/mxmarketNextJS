...
export default function Navbar({}) {
  ...
  return (
    <Fragment>
      <nav className="bg-light shadow-lg px-3 d-flex flex-row align-items-center justify-content-between">
        ...
        <div className="d-dlex flex-row align-items-center justify-content-center lg-nav">
          <ul className="d-flex flex-row align-items-center justify-content-between nav-list">
            <li>
              <Link href="/">
                <span className="nav-links pointer">Home</span>
              </Link>
            </li>
            <li>
              <Link href="/categories">
                <span className="nav-links pointer">Categories</span>
              </Link>
            </li>
            <li>
              <Link href="/blog">
                <span className="nav-links pointer">Blog</span>
              </Link>
            </li>
            <li>
              <Link href="/delivery">
                <span className="nav-links pointer">Mx Delivery</span>
              </Link>
            </li>
            <li>
              <Link href="/FAQ">
                <span className="nav-links pointer">FAQ</span>
              </Link>
            </li>
          </ul>
        </div>
        ...
        <div className="d-flex flex-row align-items-center justify-content-between profile-link">
          ...
          <Link
            href={(() => {
              if (loggedInState.loggedIn == true) {
                return `/profile/${loggedInState.user.user_name}`;
              } else {
                return `/login`;
              }
            })()}
          >
            <img
              ...
              alt="account"
              className="Accout-nav-logo pointer"
              title="my account"
            />
          </Link>
          <span
            className="btn-hover-orange btn-purple btn btn-sm text-light"
            title="Acount menu"
            ref={accountMenuBtn}
      ...
      <div
        className="sm-nav flex-column align-items-center bg-light shadow"
        ref={smNav}
      >
