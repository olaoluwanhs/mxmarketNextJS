        ...
        <Fragment>
            <footer >
                ...
                <div className="bg-dark d-flex align-items-center justify-content-center">
                    <p className="text-light d-flex align-items-center flex-column">Copyright &copy; 2022 MX market | Powered by <a href="https:cgiinc.site" className="plain-link">CGI INC</a></p>
                </div>
            </footer>
        </Fragment>
    )
